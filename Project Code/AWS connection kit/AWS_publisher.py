...
connflag = True # defining connection flag
...
awshost = "a1fead24shde1q-ats.iot.us-east-1.amazonaws.com"  # Endpoint from aws iot core > settings and end point will be same in both file 
awsport = 8883                                              # Port no. will always same 
clientId = "MyRaspberryPi1"                                     # Thing_Name in aws iot core
thingName = "MyRaspberryPi1"                                    # Thing_Name
caPath = "root-CA.crt"                                      # Root_CA_Certificate_Name provide complite path
certPath = "MyRaspberryPi1.cert.pem"                            # <Thing_Name>.cert.pem
keyPath = "MyRaspberryPi1.private.key"                          # <Thing_Name>.private.key
